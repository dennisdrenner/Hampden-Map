...
var Location = function (data) {
		...
		self.categories = data.categories;  //categories is an array 
		self.display = ko.observable(true); 
		self.latLng = {};
		self.marker = {};
		self.marker.setMap = '';
		self.summary = data.summary; 
		self.yelpId = data.yelpId;
		self.img_url = '';
		self.snippet_text = '';
		self.rating_img_url = '';
		self.icon = data.icon; // custom icon for Google map
		self.icon_selected = data.icon_selected;
...
function AppViewModel() {
	 ...
	 self.matches = ko.observableArray([]);
		...
		};  //End of custom autocomplete binding 
